...
Small polish we skipped so a phase could ship. **Not** the next-phase queue. Big holes (walk-recenter, moons, weather types, loot GUI, sunglare) stay out of this file.
