...
| **AI packages** | List is parsed ([phase 52](phase52-ai-package-list.md)). Follow, travel, duration, and idle2–9 are not run. Work order: [ai-packages.md](ai-packages.md). |
