...
| **AI packages** | The front package is active ([phase 53](phase53-active-package.md)). Only a front wander walks. Follow, travel, duration, and idle2–9 are not run. Work order: [ai-packages.md](ai-packages.md). |
